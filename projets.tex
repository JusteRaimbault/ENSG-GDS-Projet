...
\begin{itemize}
	...
	\item Données utilisées dans votre alternance avec licence ouverte
...
\begin{frame}{Années précédentes}
	\begin{itemize}
        \item 2024 : accidents routiers ; minage de bitcoin
		\item 2023 : Chômage et accessibilité en Ile-de-France ; Dynamiques électorales ;  Prix de l'essence ; Ecoutes Spotify par pays
		\item 2022 : Crimes et délits à la commune en France ; Feux de forêt aux Etats-Unis ; AirBnb à Paris ; prix immobilier (base DVF)
        \item 2021 : réseaux routier parisien ; accessibilité aux AMAP ; prix immobilier
	\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item Evaluation par présentation de 15 minutes à tous lors de la dernière séance le 16 janvier.%13 janvier  % 22 décembre 
    %(une partie de l'évaluation portera sur le retour des autres).
